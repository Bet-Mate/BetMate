...
export default function FeaturesSection () {
    return (
        <section className="bg-gradient-to-l from-[#181818]/50 to-blue-800/90 py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#181818] p-8 rounded-xl card-hover">
              <div className="bg-white dark:bg-blue-800/90 w-14 h-14 rounded-full flex items-center justify-center mb-6">
